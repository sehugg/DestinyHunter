...
{
#ifdef TARGET_A2
	155, 140, 143, 142, 135, 160, 129, 135, 143, 161, 157    // [LONG AGO!]
#else
...
*/	
	151, 151, 151, 174,  // www.
	132, 133, 147, 148, 137, 142, 153, 136, 149, 142, 148, 133, 146, 174,  // destinyhunter.
	143, 146, 135  // org
	//13, 25, 32,   // my
	//7, 1, 13, 5 // game
};
...
char str_haiku1[] =
{  // be at peace again
	130, 133, 160, 129, 148, 160, 144, 133, 129, 131, 133, 160, 129, 135, 129, 137, 142
};

char str_haiku2[] =
{  // till the next cycle begins
	148, 137, 140, 140, 160, 148, 136, 133, 160, 142, 133, 152, 148, 160, 131, 153, 131, 140, 133, 160, 130, 133, 135, 137, 142, 147
};

char str_haiku3[] =
{  // you three stay within
	153, 143, 149, 160, 148, 136, 146, 133, 133, 160, 147, 148, 129, 153, 160, 151, 137, 148, 136, 137, 142
};
